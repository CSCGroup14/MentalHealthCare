...
class _AnxietyPageState extends State<AnxietyPage> {
  ...
  final CollectionReference<Map<String, dynamic>> postsCollection1 =
      FirebaseFirestore.instance.collection('anxiety posts');
  ...
  Future<String?> getImage() async {
    ...
    if (pickedImage != null) {
      ...
      await postsCollection1.add(post.toMap());
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text("Anxiety Community"),
      ),
      body: Column(
        children: [
          Container(
